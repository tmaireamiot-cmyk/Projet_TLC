...
public class AST_decore implements MonVisiteur {
    ...
    public void visit(CommonTree node,ArrayList<String> tab) {
        ...
        // Assurer que la position source est enregistrée dans le noeud décoré
        if (node.getToken() != null) {
            noeud_decore.setLine(node.getToken().getLine());
            noeud_decore.setCol(node.getToken().getCharPositionInLine());
        }
