...
public class whileParser extends DebugParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "PROGRAM", "FUNCTION", "DEFINITION", "INPUT", "INPUTSUB", "OUTPUT", "COMMANDS", "COMMAND", "VARS", "EXPRS", "EXPRESSION", "EXPRBASE", "LEXPR", "NOP", "VARIABLES", "EXPRESSIONS", "VAR", "IF", "VARIABLE", "SYMBOL", "COMMA", "PERCENT", "'function'", "':'", "'read'", "'write'", "';'", "'nop'", "':='", "'if'", "'then'", "'else'", "'fi'", "'while'", "'do'", "'od'", "'for'", "'foreach'", "'in'", "'nil'", "'('", "'list'", "')'", "'cons'", "'hd'", "'tl'", "'=?'"
    };
    ...
    public static final String[] ruleNames = new String[] {
        "invalidRule", "output", "command_for", "commands", "exprbase_list", 
        "exprbase_hd", "definition", "command", "exprbase_symbol2", "exprs", 
        "vars", "exprbase_symbol", "exprbase", "exprbase_variable", "exprbase_cons", 
        "command_nop", "command_while", "exprbase_tl", "expression", "program", 
        "command_var", "command_if", "lexpr", "exprbase_nil", "command_foreach", 
        "input", "function"
    };
    ...
    public final whileParser.function_return function() throws RecognitionException {
        ...
        try {
            ...
            {
            dbg.location(37,12);
            string_literal2=(Token)match(input,26,FOLLOW_26_in_function266);  
            ...
            dbg.location(37,32);
            char_literal3=(Token)match(input,27,FOLLOW_27_in_function272);  
    ...
    public final whileParser.definition_return definition() throws RecognitionException {
        ...
        try {
            ...
            {
            dbg.location(40,7);
            string_literal5=(Token)match(input,28,FOLLOW_28_in_definition297);  
            stream_28.add(string_literal5);
            ...
            dbg.location(40,50);
            string_literal8=(Token)match(input,29,FOLLOW_29_in_definition312);  
            ...
            // 40:67: -> ^( DEFINITION ^( INPUT ( $i)? ) ^( OUTPUT $o) $c)
            {
                ...
                dbg.location(40,91);
                // C:\\Users\\tmami\\github-classroom\\Projet_TLC\\while.g:40:91: ( $i)?
                if ( stream_i.hasNext() ) {
                    dbg.location(40,91);
    ...
    public final whileParser.command_nop_return command_nop() throws RecognitionException {
        ...
        try {
            ...
            {
            dbg.location(52,15);
            string_literal14=(Token)match(input,31,FOLLOW_31_in_command_nop500);  
    ...
    public final whileParser.command_var_return command_var() throws RecognitionException {
        ...
        try {
            ...
            dbg.location(54,20);
            string_literal16=(Token)match(input,32,FOLLOW_32_in_command_var516);  
    ...
    public final whileParser.command_if_return command_if() throws RecognitionException {
        ...
        try {
            ...
            {
            dbg.location(57,7);
            string_literal18=(Token)match(input,33,FOLLOW_33_in_command_if540);  
            ...
            dbg.location(57,23);
            string_literal20=(Token)match(input,34,FOLLOW_34_in_command_if544);  
            ...
            switch (alt8) {
                case 1 :
                    ...
                    {
                    dbg.location(57,43);
                    string_literal21=(Token)match(input,35,FOLLOW_35_in_command_if551);  
            ...
            dbg.location(57,64);
            string_literal22=(Token)match(input,36,FOLLOW_36_in_command_if559);  
            stream_36.add(string_literal22);



            // AST REWRITE
            // elements: 33, expression, c1, c2
            // token labels: 
    ...
    public final whileParser.command_while_return command_while() throws RecognitionException {
        ...
        try {
            ...
            {
            dbg.location(61,17);
            string_literal23=(Token)match(input,37,FOLLOW_37_in_command_while597);  
            ...
            dbg.location(61,36);
            string_literal25=(Token)match(input,38,FOLLOW_38_in_command_while601);  
            ...
            dbg.location(61,50);
            string_literal27=(Token)match(input,39,FOLLOW_39_in_command_while605);  
    ...
    public final whileParser.command_for_return command_for() throws RecognitionException {
        ...
        try {
            ...
            {
            dbg.location(63,15);
            string_literal28=(Token)match(input,40,FOLLOW_40_in_command_for625);  
            ...
            dbg.location(63,32);
            string_literal30=(Token)match(input,38,FOLLOW_38_in_command_for629);  
            ...
            dbg.location(63,46);
            string_literal32=(Token)match(input,39,FOLLOW_39_in_command_for633);  
            stream_39.add(string_literal32);



            // AST REWRITE
            // elements: expression, commands, 40
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final whileParser.command_foreach_return command_foreach() throws RecognitionException {
        ...
        try {
            ...
            {
            dbg.location(65,19);
            string_literal33=(Token)match(input,41,FOLLOW_41_in_command_foreach653);  
            ...
            dbg.location(65,38);
            string_literal35=(Token)match(input,42,FOLLOW_42_in_command_foreach657);  
            ...
            dbg.location(65,54);
            string_literal37=(Token)match(input,38,FOLLOW_38_in_command_foreach661);  
            stream_38.add(string_literal37);
            ...
            dbg.location(65,68);
            string_literal39=(Token)match(input,39,FOLLOW_39_in_command_foreach665);  
            stream_39.add(string_literal39);



            // AST REWRITE
            // elements: expression, commands, 41, VARIABLE
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final whileParser.exprbase_list_return exprbase_list() throws RecognitionException {
        ...
        try {
            ...
            {
            dbg.location(80,16);
            char_literal47=(Token)match(input,44,FOLLOW_44_in_exprbase_list795);  
            stream_44.add(char_literal47);

            dbg.location(80,20);
            string_literal48=(Token)match(input,45,FOLLOW_45_in_exprbase_list797);  
            stream_45.add(string_literal48);
            ...
            stream_lexpr.add(lexpr49.getTree());
            dbg.location(80,33);
            char_literal50=(Token)match(input,46,FOLLOW_46_in_exprbase_list801);  
    ...
    public final whileParser.exprbase_cons_return exprbase_cons() throws RecognitionException {
        ...
        try {
            ...
            {
            dbg.location(81,16);
            char_literal51=(Token)match(input,44,FOLLOW_44_in_exprbase_cons817);  
            stream_44.add(char_literal51);

            dbg.location(81,20);
            string_literal52=(Token)match(input,47,FOLLOW_47_in_exprbase_cons819);  
            ...
            dbg.location(81,33);
            char_literal54=(Token)match(input,46,FOLLOW_46_in_exprbase_cons823);  
    ...
    public final whileParser.exprbase_hd_return exprbase_hd() throws RecognitionException {
        ...
        try {
            ...
            {
            dbg.location(82,14);
            char_literal55=(Token)match(input,44,FOLLOW_44_in_exprbase_hd839);  
            stream_44.add(char_literal55);

            dbg.location(82,18);
            string_literal56=(Token)match(input,48,FOLLOW_48_in_exprbase_hd841);  
            ...
            dbg.location(82,32);
            char_literal58=(Token)match(input,46,FOLLOW_46_in_exprbase_hd845);  
            stream_46.add(char_literal58);
    ...
    public final whileParser.exprbase_tl_return exprbase_tl() throws RecognitionException {
        ...
        try {
            ...
            {
            dbg.location(83,14);
            char_literal59=(Token)match(input,44,FOLLOW_44_in_exprbase_tl861);  
            stream_44.add(char_literal59);

            dbg.location(83,18);
            string_literal60=(Token)match(input,49,FOLLOW_49_in_exprbase_tl863);  
            ...
            dbg.location(83,32);
            char_literal62=(Token)match(input,46,FOLLOW_46_in_exprbase_tl867);  
            stream_46.add(char_literal62);
    ...
    public final whileParser.exprbase_symbol2_return exprbase_symbol2() throws RecognitionException {
        ...
        try {
            ...
            {
            dbg.location(84,19);
            char_literal63=(Token)match(input,44,FOLLOW_44_in_exprbase_symbol2883);  
            ...
            dbg.location(84,38);
            char_literal65=(Token)match(input,46,FOLLOW_46_in_exprbase_symbol2891);  
            stream_46.add(char_literal65);
        ...
        try {
            ...
            switch (alt11) {
                case 1 :
                    ...
                    {
                    dbg.location(97,26);
                    string_literal74=(Token)match(input,50,FOLLOW_50_in_expression988);  
    ...
    public final whileParser.lexpr_return lexpr() throws RecognitionException {
        ...
        whileParser.exprbase_return e = null;
        ...
        try {
            ...
            do {
                ...
                if ( ((LA12_0>=VARIABLE && LA12_0<=SYMBOL)||(LA12_0>=43 && LA12_0<=44)) ) {
                    alt12=1;
                }
            ...
            // 99:21: -> ^( LEXPR ( $e)* )
            {
                ...
                dbg.location(99,32);
                // C:\\Users\\tmami\\github-classroom\\Projet_TLC\\while.g:99:32: ( $e)*
                while ( stream_e.hasNext() ) {
                    dbg.location(99,32);
                    adaptor.addChild(root_1, stream_e.nextTree());
    ...
    class DFA10 extends DFA {
        ...
        public String getDescription() {
            return "86:1: exprbase : ( exprbase_nil | exprbase_variable | exprbase_list | exprbase_cons | exprbase_hd | exprbase_tl | exprbase_symbol2 | exprbase_symbol );";
        }
    ...
    public static final BitSet FOLLOW_function_in_program248 = new BitSet(new long[]{0x0000000004000002L});
    public static final BitSet FOLLOW_26_in_function266 = new BitSet(new long[]{0x0000000000800000L});
    public static final BitSet FOLLOW_SYMBOL_in_function270 = new BitSet(new long[]{0x0000000008000000L});
    public static final BitSet FOLLOW_27_in_function272 = new BitSet(new long[]{0x0000000010000000L});
    public static final BitSet FOLLOW_definition_in_function274 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_28_in_definition297 = new BitSet(new long[]{0x0000000002400000L});
    public static final BitSet FOLLOW_input_in_definition301 = new BitSet(new long[]{0x0000000002000000L});
    public static final BitSet FOLLOW_PERCENT_in_definition304 = new BitSet(new long[]{0x0000032280400000L});
    public static final BitSet FOLLOW_commands_in_definition308 = new BitSet(new long[]{0x0000000002000000L});
    public static final BitSet FOLLOW_PERCENT_in_definition310 = new BitSet(new long[]{0x0000000020000000L});
    public static final BitSet FOLLOW_29_in_definition312 = new BitSet(new long[]{0x0000000000400000L});
    public static final BitSet FOLLOW_output_in_definition316 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_VARIABLE_in_input355 = new BitSet(new long[]{0x0000000001000002L});
    public static final BitSet FOLLOW_COMMA_in_input358 = new BitSet(new long[]{0x0000000000400000L});
    public static final BitSet FOLLOW_VARIABLE_in_input362 = new BitSet(new long[]{0x0000000001000002L});
    public static final BitSet FOLLOW_VARIABLE_in_output384 = new BitSet(new long[]{0x0000000001000002L});
    public static final BitSet FOLLOW_COMMA_in_output387 = new BitSet(new long[]{0x0000000000400000L});
    public static final BitSet FOLLOW_VARIABLE_in_output391 = new BitSet(new long[]{0x0000000001000002L});
    public static final BitSet FOLLOW_VARIABLE_in_vars413 = new BitSet(new long[]{0x0000000001000002L});
    public static final BitSet FOLLOW_COMMA_in_vars416 = new BitSet(new long[]{0x0000000000400000L});
    public static final BitSet FOLLOW_VARIABLE_in_vars420 = new BitSet(new long[]{0x0000000001000002L});
    public static final BitSet FOLLOW_expression_in_exprs442 = new BitSet(new long[]{0x0000000001000002L});
    public static final BitSet FOLLOW_COMMA_in_exprs445 = new BitSet(new long[]{0x0000180000C00000L});
    public static final BitSet FOLLOW_expression_in_exprs449 = new BitSet(new long[]{0x0000000001000002L});
    public static final BitSet FOLLOW_command_in_commands471 = new BitSet(new long[]{0x0000000040000002L});
    public static final BitSet FOLLOW_30_in_commands475 = new BitSet(new long[]{0x0000032280400000L});
    public static final BitSet FOLLOW_command_in_commands479 = new BitSet(new long[]{0x0000000040000002L});
    public static final BitSet FOLLOW_31_in_command_nop500 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_vars_in_command_var514 = new BitSet(new long[]{0x0000000100000000L});
    public static final BitSet FOLLOW_32_in_command_var516 = new BitSet(new long[]{0x0000180000C00000L});
    public static final BitSet FOLLOW_exprs_in_command_var518 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_33_in_command_if540 = new BitSet(new long[]{0x0000180000C00000L});
    public static final BitSet FOLLOW_expression_in_command_if542 = new BitSet(new long[]{0x0000000400000000L});
    public static final BitSet FOLLOW_34_in_command_if544 = new BitSet(new long[]{0x0000032280400000L});
    public static final BitSet FOLLOW_commands_in_command_if548 = new BitSet(new long[]{0x0000001800000000L});
    public static final BitSet FOLLOW_35_in_command_if551 = new BitSet(new long[]{0x0000032280400000L});
    public static final BitSet FOLLOW_commands_in_command_if555 = new BitSet(new long[]{0x0000001000000000L});
    public static final BitSet FOLLOW_36_in_command_if559 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_37_in_command_while597 = new BitSet(new long[]{0x0000180000C00000L});
    public static final BitSet FOLLOW_expression_in_command_while599 = new BitSet(new long[]{0x0000004000000000L});
    public static final BitSet FOLLOW_38_in_command_while601 = new BitSet(new long[]{0x0000032280400000L});
    public static final BitSet FOLLOW_commands_in_command_while603 = new BitSet(new long[]{0x0000008000000000L});
    public static final BitSet FOLLOW_39_in_command_while605 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_40_in_command_for625 = new BitSet(new long[]{0x0000180000C00000L});
    public static final BitSet FOLLOW_expression_in_command_for627 = new BitSet(new long[]{0x0000004000000000L});
    public static final BitSet FOLLOW_38_in_command_for629 = new BitSet(new long[]{0x0000032280400000L});
    public static final BitSet FOLLOW_commands_in_command_for631 = new BitSet(new long[]{0x0000008000000000L});
    public static final BitSet FOLLOW_39_in_command_for633 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_41_in_command_foreach653 = new BitSet(new long[]{0x0000000000400000L});
    public static final BitSet FOLLOW_VARIABLE_in_command_foreach655 = new BitSet(new long[]{0x0000040000000000L});
    public static final BitSet FOLLOW_42_in_command_foreach657 = new BitSet(new long[]{0x0000180000C00000L});
    public static final BitSet FOLLOW_expression_in_command_foreach659 = new BitSet(new long[]{0x0000004000000000L});
    public static final BitSet FOLLOW_38_in_command_foreach661 = new BitSet(new long[]{0x0000032280400000L});
    public static final BitSet FOLLOW_commands_in_command_foreach663 = new BitSet(new long[]{0x0000008000000000L});
    public static final BitSet FOLLOW_39_in_command_foreach665 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_44_in_exprbase_list795 = new BitSet(new long[]{0x0000200000000000L});
    public static final BitSet FOLLOW_45_in_exprbase_list797 = new BitSet(new long[]{0x0000580000C00000L});
    public static final BitSet FOLLOW_lexpr_in_exprbase_list799 = new BitSet(new long[]{0x0000400000000000L});
    public static final BitSet FOLLOW_46_in_exprbase_list801 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_44_in_exprbase_cons817 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_47_in_exprbase_cons819 = new BitSet(new long[]{0x0000580000C00000L});
    public static final BitSet FOLLOW_lexpr_in_exprbase_cons821 = new BitSet(new long[]{0x0000400000000000L});
    public static final BitSet FOLLOW_46_in_exprbase_cons823 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_44_in_exprbase_hd839 = new BitSet(new long[]{0x0001000000000000L});
    public static final BitSet FOLLOW_48_in_exprbase_hd841 = new BitSet(new long[]{0x0000180000C00000L});
    public static final BitSet FOLLOW_exprbase_in_exprbase_hd843 = new BitSet(new long[]{0x0000400000000000L});
    public static final BitSet FOLLOW_46_in_exprbase_hd845 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_44_in_exprbase_tl861 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_exprbase_tl863 = new BitSet(new long[]{0x0000180000C00000L});
    public static final BitSet FOLLOW_exprbase_in_exprbase_tl865 = new BitSet(new long[]{0x0000400000000000L});
    public static final BitSet FOLLOW_46_in_exprbase_tl867 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_44_in_exprbase_symbol2883 = new BitSet(new long[]{0x0000000000800000L});
    public static final BitSet FOLLOW_SYMBOL_in_exprbase_symbol2887 = new BitSet(new long[]{0x0000580000C00000L});
    public static final BitSet FOLLOW_lexpr_in_exprbase_symbol2889 = new BitSet(new long[]{0x0000400000000000L});
    public static final BitSet FOLLOW_46_in_exprbase_symbol2891 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_exprbase_in_expression985 = new BitSet(new long[]{0x0004000000000002L});
    public static final BitSet FOLLOW_50_in_expression988 = new BitSet(new long[]{0x0000180000C00000L});
    public static final BitSet FOLLOW_exprbase_in_expression992 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_exprbase_in_lexpr1019 = new BitSet(new long[]{0x0000180000C00002L});
